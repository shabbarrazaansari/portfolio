      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <motion.div 
            ...
            className="text-tertiary mb-4 md:mb-0"
          >
            &copy; {currentYear} Shabbar Ansari. All rights reserved.
          </motion.div>
            ...
            <ul className="flex space-x-6">
              <li>
                <Link
                  ...
                  offset={-70}
                  duration={500}
                  className="text-tertiary hover:text-secondary transition-colors duration-300 cursor-pointer"
                >
                  Home
                </Link>
              </li>
